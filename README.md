...
<p align="center">
  <img alt="Version"      src="https://img.shields.io/badge/version-v1.0.0-4A9D8E?style=for-the-badge">
...
**Download it** — `resonance-1.0.0-1-x86_64.pkg.tar.zst` is on the
[Releases page](https://github.com/sudo-megas/RESONANCE/releases), so there is nothing to
build:

```bash
sudo pacman -U resonance-1.0.0-1-x86_64.pkg.tar.zst
```
...
**Download it** — `resonance_1.0.0_amd64.deb` is on the
[Releases page](https://github.com/sudo-megas/RESONANCE/releases):

```bash
sudo dpkg -i resonance_1.0.0_amd64.deb || sudo apt-get install -f
```
