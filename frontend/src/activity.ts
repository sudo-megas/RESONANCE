...
//
// undo stays although v1.4.0 removed the feature. Nothing writes new entries
// of that kind, but logs written before the upgrade still hold them, and an
// entry whose glyph has been deleted renders as a blank where every sibling
// has an icon. The log is a record of what happened, so it keeps describing
// what happened.
